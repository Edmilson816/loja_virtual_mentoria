...
public class ConsultaCnpjDTO implements Serializable {
	...
	/**Utilizado na comunicação com a api da receita federal. 
	 * O nome do atributo precisa ser igual ao da API
	 */
	private static final long serialVersionUID = 1L;
	                   
	/*Foi criado este objeto por que se tratava de uma lista retornada pela receita*/
	...
	@JsonIgnore /**/
	private ExtraDTO extra; /*Retornado pela receita vazio mais precisamos declarar*/

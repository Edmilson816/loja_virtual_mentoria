...
public class VendaCompraLojaVirtual implements Serializable  {
	...
	@Min(value = 1, message = "O Valor total da venda é invalida!")
	...
	private CupDesc cupDesc; // Cupom de desconto 
	
	@Column(nullable = false)
	private BigDecimal valorFrete;
	
	@Min(value = 1, message = "Dia da entrega inválida!")
	@Column(nullable = false)
	private Integer diaEntrega;
	
	@NotNull(message = "Data da venda de ser informada!")
	@Column(nullable = false)
	@Temporal(TemporalType.DATE)
	private Date dataVenda;
	
	@NotNull(message = "Data da entrega de ser informada!")
	@Column(nullable = false)
	@Temporal(TemporalType.DATE)
	private Date dataEntrega;
	
	@NotNull(message = "A empresa dona do pedido deve ser informada!")

...
public class ImagemProdutoController {
	...
	public ResponseEntity<ImagemProdutoDTO> salvarImagemProduto(@RequestBody ImagemProduto imagemProduto){
		...
		imagemProduto = imagemProdutoRepository.saveAndFlush(imagemProduto); /*Salva direto no banco */
	...
	public ResponseEntity<?> deleteTodoImagemProduto(@PathVariable("idProduto") Long idProduto) {
		...
		imagemProdutoRepository.deleteImagem(idProduto); /*Remove as imagens com base no id do produto ou seja todas as imagens de vez*/
	...
	public ResponseEntity<?> deleteImagemProdutoPorId(@RequestBody ImagemProduto imagemProduto) {
		...
		if(!imagemProdutoRepository.existsById(imagemProduto.getId())) { /*Remove apenas 1 imagem de cada vez*/
